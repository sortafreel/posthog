...
class AiEventsTable(Table):
    fields: dict[str, FieldOrTable] = {
        ...
        # Heavy columns
        "input": StringDatabaseField(name="input", nullable=False),
        "output": StringDatabaseField(name="output", nullable=False),
        "output_choices": StringDatabaseField(name="output_choices", nullable=False),
        "input_state": StringDatabaseField(name="input_state", nullable=False),
        "output_state": StringDatabaseField(name="output_state", nullable=False),
        "tools": StringDatabaseField(name="tools", nullable=False),
