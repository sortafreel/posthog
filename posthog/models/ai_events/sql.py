...
AS SELECT
    ...
    JSONExtractString(properties, '$ai_span_type') AS span_type,
    ...
    JSONExtractString(properties, '$ai_prompt_name') AS prompt_name,
    ...
    -- Token counts
    JSONExtractInt(properties, '$ai_total_tokens') AS total_tokens,
    JSONExtractInt(properties, '$ai_input_tokens') AS input_tokens,
    JSONExtractInt(properties, '$ai_output_tokens') AS output_tokens,
    JSONExtractInt(properties, '$ai_text_input_tokens') AS text_input_tokens,
    JSONExtractInt(properties, '$ai_text_output_tokens') AS text_output_tokens,
    JSONExtractInt(properties, '$ai_image_input_tokens') AS image_input_tokens,
    JSONExtractInt(properties, '$ai_image_output_tokens') AS image_output_tokens,
    JSONExtractInt(properties, '$ai_audio_input_tokens') AS audio_input_tokens,
    JSONExtractInt(properties, '$ai_audio_output_tokens') AS audio_output_tokens,
    JSONExtractInt(properties, '$ai_video_input_tokens') AS video_input_tokens,
    JSONExtractInt(properties, '$ai_video_output_tokens') AS video_output_tokens,
    JSONExtractInt(properties, '$ai_reasoning_tokens') AS reasoning_tokens,
    JSONExtractInt(properties, '$ai_cache_read_input_tokens') AS cache_read_input_tokens,
    JSONExtractInt(properties, '$ai_cache_creation_input_tokens') AS cache_creation_input_tokens,
    JSONExtractInt(properties, '$ai_web_search_count') AS web_search_count,
    ...
    JSONExtractFloat(properties, '$ai_request_cost_usd') AS request_cost_usd,
    JSONExtractFloat(properties, '$ai_web_search_cost_usd') AS web_search_cost_usd,
    JSONExtractFloat(properties, '$ai_audio_cost_usd') AS audio_cost_usd,
    JSONExtractFloat(properties, '$ai_image_cost_usd') AS image_cost_usd,
    JSONExtractFloat(properties, '$ai_video_cost_usd') AS video_cost_usd,

    -- Timing
    JSONExtractFloat(properties, '$ai_latency') AS latency,
    JSONExtractFloat(properties, '$ai_time_to_first_token') AS time_to_first_token,

    -- Errors
    if(JSONExtractString(properties, '$ai_is_error') = 'true', 1, 0) AS is_error,
    JSONExtractString(properties, '$ai_error') AS error,
    JSONExtractString(properties, '$ai_error_type') AS error_type,
